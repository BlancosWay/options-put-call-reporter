...
Treat generated reports as options-sentiment research, not financial advice. Never paste secrets into chat; Resend API keys should stay in macOS Keychain via `options-put-call-report setup-email`.
