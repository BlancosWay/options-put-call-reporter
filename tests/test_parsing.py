...
def test_parse_percent_wraps_malformed_values() -> None:
...
def test_parse_int_wraps_malformed_values() -> None:
...
def test_parse_float_wraps_malformed_values() -> None:
...
def test_parse_expiration_label_rejects_missing_kind() -> None:
    with pytest.raises(ParseError, match="expiration"):
        parse_expiration_label("06/18/26")
